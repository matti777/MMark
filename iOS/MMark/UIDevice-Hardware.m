...
- (NSString *) hwmodel
{
    return [self getSysInfoByName:(char*)"hw.model"];
}
...
//    NSLog(@"platform: %@", platform);
     ...
     */
    if ([platform isEqualToString:@"iPad2,5"]) return UIDeviceMiniiPad;
    if ([platform isEqualToString:@"iPad2,6"]) return UIDeviceMiniiPad;
    if ([platform isEqualToString:@"iPad2,7"]) return UIDeviceMiniiPad;
    ...
    // Rest of the devices with iPad3 prefix are iPad3:s
